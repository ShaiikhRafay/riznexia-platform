...
// Select Lead (F11 Dashboard): reuses F4's `useLeads()` directly, same as
// F6-F9's own `LeadSelect`. Feature-local duplicate, not a cross-feature
// import — this codebase's only established reuse convention is at the
// hook/`api/` layer, never across a `components/` tree (DECISIONS.md
// D-162).
