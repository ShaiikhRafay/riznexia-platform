...
// Select Lead (F9 Dashboard feature): reuses F4's `useLeads()` directly,
// same as F6/F7/F8's own `LeadSelect`. Feature-local duplicate, not a
// cross-feature import — this codebase's only established reuse
// convention is at the hook/`api/` layer, never across a `components/`
// tree (DECISIONS.md D-162).
