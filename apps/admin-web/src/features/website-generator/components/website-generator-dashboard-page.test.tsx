...
import { WebsiteGeneratorDashboardPage } from './website-generator-dashboard-page';
  ...
  return render(
    <QueryClientProvider client={queryClient}>
      <PermissionsProvider role="admin">
        <WebsiteGeneratorDashboardPage />
      </PermissionsProvider>
    </QueryClientProvider>,
  );
}

describe('WebsiteGeneratorDashboardPage', () => {
  beforeEach(() => {
    push.mockClear();
  ...
  it('shows no panel until a lead is selected', () => {
    ...
    expect(screen.queryByText(/Website generation needs/)).not.toBeInTheDocument();
  });
