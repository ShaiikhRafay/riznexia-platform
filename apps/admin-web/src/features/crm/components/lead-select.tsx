...
// Select Lead (F10, reused across Tasks-create/Activities/Proposals):
// feature-local duplicate of F6-F9's own, a thin wrapper around F4's
// `useLeads()`. Feature-local duplication, not a cross-feature import —
// this codebase's only established reuse convention is at the hook/`api/`
// layer, never across a `components/` tree (DECISIONS.md D-162).
