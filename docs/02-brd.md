...
>
> **Doc-sync note (2026-07-29):** Reviewed against the implemented architecture through Module M3 (Authentication & RBAC). No business requirement changed — only the role-list example in §4 was corrected to match the six roles actually implemented. See DECISIONS.md D-029.
...
- Internal team accounts with roles (Super Admin, Admin, Sales Manager, Sales Executive, Developer, Viewer — Module M3, see Security Strategy §1)
